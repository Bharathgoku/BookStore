...
@ComponentScan(includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE,classes = {
    MediaCoverageService.class, MediaCoverageApiManager.class, HttpRequestUtil.class, RestTemplateConfig.class, MediaCoverageController.class}), basePackages = {"com.bookstore.*"})
@SpringBootApplication(scanBasePackageClasses = {MediaCoverageService.class, MediaCoverageApiManager.class, HttpRequestUtil.class,RestTemplateConfig.class, MediaCoverageController.class})
